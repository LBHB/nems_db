...
from nems_lbhb.projects.olp.OLP_fit import calc_dyn_metrics
...
print(f"Running OLP dynamic prediction cell {cellid}")
...
_ = calc_dyn_metrics(cellid=cellid, batch=batch, parmfile=parmfile)
