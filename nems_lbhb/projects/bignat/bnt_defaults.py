...
cnnsingle="wc.18x1x6.g-fir.25x1x6-relu.6.f-wc.6x1-{outnl}"
...
shortnames = ['1D-CNNx2', 'POP-LN', 'single-CNN', 'POP-L', '1D-CNNx2f']
...
def list_pop_models_old():
    ...
    POP_MODELS_OLD = [
        ...
        f"{load_string_pop}_wc.18x70.g-fir.1x15x70-relu.70.f-wc.70x80-fir.1x10x80-relu.80.f-wc.80x100-relu.100.f-wc.100xR-{outnl}_{fit_string_pop}", # c1dx2+d
        f"{load_string_pop}_wc.18x120.g-fir.1x25x120-wc.120xR-{outnl}_{fit_string_pop}", # LN_pop
        f"{load_string_pop}_wc.18x100.g-fir.1x25x100-relu.100.f-wc.100x120-relu.120.f-wc.120xR-{outnl}_{fit_string_pop}", # c1d
        f"{load_string_pop}_wc.18x120.g-fir.1x25x120-wc.120xR-lvl.R_{fit_string_pop}", # L_pop
