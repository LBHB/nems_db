...
modelnames = [
    'gtgram.fs100.ch18.pop-loadpop-norm.l1-popev_wc.18x1x70.g-fir.15x1x70-relu.70.f-wc.70x1x80-fir.10x1x80-relu.80.f-wc.80x100-relu.100-wc.100xR-dexp.R_lite.tf.init.lr1e3.t3.es20.rb10-lite.tf.lr5e4-lite.tf.lr1e4',
    'ozgf.fs100.ch18.pop-loadpop-norm.l1-popev_wc.18x70.g-fir.1x15x70-relu.70.f-wc.70x80-fir.1x10x80-relu.80.f-wc.80x100-relu.100-wc.100xR-lvl.R-dexp.R_tfinit.n.lr1e3.et3.es20-newtf.n.lr1e4',
]

cellid = 'NAT4v2'
batch = 322

xf, ctx = fit_model_xform(cellid, batch, modelnames[0], returnModel=True)
xf2, ctx2 = fit_model_xform(cellid, batch, modelnames[1], returnModel=True)