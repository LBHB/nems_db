...
d_b307['onBF'] = 'TBD'
d_b307['SU'] = False
d_b307.loc[d_pb307['isolation']>=90.0, 'SU'] = True
...
d_b311['onBF'] = 'TBD'
d_b311['SU'] = False
d_b311.loc[d_pb307['isolation']>=90.0, 'SU'] = True
...
dfb = pd.concat([d_b307, d_b311, d_b313], sort=False)
