...
# Hopefully the last iteration... simplified to just use summed contrast and
# no parameters for it, no random conditions, always post-fit, etc.
def fit_gc4(modelspec, est, val, max_iter=1000, prefit_max_iter=700, tolerance=1e-7,
            prefit_tolerance=10**-5.5, metric='nmse', fitter='scipy_minimize',
            cost_function=None, IsReload=False, **context):
    '''
    Xforms wrapper for fitting the locked STRF=CTSTRF version of the GC model.
