...
def pop_selector(recording_uri_list, batch=None, cellid=None,
                 ...
                 whiten=True, meta={}, skip_cellids=False, **context):
    ...
    if not skip_cellids:
        ...
        cellid = ["%s-%d" % (cellid, i) for i in indices]
        log.info("pop_selector: skipping siteid parsing, using default integer indices for cellids")
