...
def submit_exacloud_job(*, user, cellid='', batch='', modelname='', exec_path=None, script_path=None, password=None,
                        ssh_key=None):
    """Submits a job on the exacloud cluster. All arguments must be named.
...
if __name__ == '__main__':
    ...
    submit_exacloud_job(user=args.user, ssh_key=args.ssh_key, password=args.password, exec_path=args.exec_path,
